...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<RouteAuthorizationPolicy> AUTHORIZATION_POLICIES = List.of(
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/skills/*/*/usage-stats"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/skills/*/*/usage-stats"),
            ...
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/cli/v1/skill-usage-events"),
    ...
    private static final List<ApiTokenPolicy> API_TOKEN_POLICIES = List.of(
            ...
            ApiTokenPolicy.allow(HttpMethod.POST, "/api/cli/v1/skill-usage-events"),
